...
% IMPOSEDDATA Find the available scoped Gotos and Data Stores that are higher in
%   the hierarchy and are to be in the signature.
%
%   Inputs:
%       address     Simulink model name or path.
%
%   Outputs:
%       tagDex      Names of Gotos in scope of the system.
