...
%repositionGlobals repositions added gotos/froms that represent globals on
%the signature.
%
%   INPUTS
%
...
%   -num: Binary digit indicating the orientation of the block and terminator. 1 is block
%   on the left of the terminator, 0 is block on the right of it.
%
%   OUTPUTS
%
%   -yOffsetFinal: After repositioning the blocks, the offset to be passed
%   out.
