...
% Find the full path of the block in system sys with block type blockType,
% and a name of blockID.
%   **For blocks with a tag parameter such as GotoTag or DataStoreName,
%   blockID is assumed to be that tag (any block with this tag is accepted)
%
% Also returns logical isTag which is true if the block had a tag parameter
